...
public class EditPermission extends Command
{
	...
	public void oncommand(TurkeyBot bot, String channel, String sender, String login, String hostname, String message)
	{
		...
		if(contents.length != 3) bot.sendMessage(bot.capitalizeName(sender) + ": That is not valid! Try !editCommand <command> <Perm>");
		...
		if(c != null)
		{
			if(c.isValidPerm(perm)) c.setPermissionLevel(perm);
			else
			{
