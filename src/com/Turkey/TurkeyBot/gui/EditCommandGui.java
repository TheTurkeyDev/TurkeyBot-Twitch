...
public class EditCommandGui implements ActionListener
{
	...
	public EditCommandGui(Command c)
	{
		...
		cooldownLabel.setLocation(10, 90);
		cooldownLabel.setSize(75, 25);
		popup.add(cooldownLabel);

		SpinnerModel model = new SpinnerNumberModel(command.getCommandCooldown(), 0, Integer.MAX_VALUE, 1);
		cooldown = new JSpinner(model);
		cooldown.setName("Cooldown");
		cooldown.setLocation(125, 90);
		cooldown.setSize(100, 30);
		popup.add(cooldown);

		responseLabel = new JLabel("Responses:");
		responseLabel.setLocation(10, 130);
		...
		if(command.canEdit())
		{
			...
			responseAdd.setLocation(125, 130);
		...
		responsesScroller.setLocation(10, 165);
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource() instanceof JButton)
		{
			...
			if(button.getName().equalsIgnoreCase(save.getName()))
			{
				...
				command.setCommandCooldown((int) cooldown.getValue());
